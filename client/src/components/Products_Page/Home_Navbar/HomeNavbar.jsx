        ...
        <>
            ...
            <div className={styles.HomeNavbar_main_Container_div_for_all}>
                ...
                <div className={styles.HomeNavbar_child_Container_div2_for_all}>
                    <div>
                        <button style={{ fontWeight: "bold" }} className={styles.HomeNavbar_child_Container_button_for_all}>
                            Book a demo
                        </button>
                    </div>

                    <hr style={{ height: "25px", width: "1px", backgroundColor: "#FCE5D8", marginTop: "32px", marginRight: "-20px", marginLeft: "20px" }} />
                    ...
                    >
                        <button className={styles.HomeNavbar_child_Container_Try_for_free_button_for_all}>
                            Try for free
                        </button>
                    </div>
                </div>
