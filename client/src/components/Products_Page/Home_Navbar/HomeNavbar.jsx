...
const HomeNavbar = () => {
  ...
  const homePage = async () => {
    ...
    let response = await axios
      .get(`https://toggl-track-clone.herokuapp.com/${localToken}`)
      .catch((err) => {
        console.log("err:", err);
  ...
  return (
    <>
      <div className={styles.HomeNavbar_main_Container_div_for_all}>
        <div className={styles.HomeNavbar_child_Container_div_for_all}>
          <div
            onClick={() => {
              navigate("/");
            }}
            className={styles.HomeNavbar_child_Container_svg_button_for_all}
          >
            {/* <button> */}
            <svg
              viewBox="0 0 167 33"
              fill="#E57CD8"
              className={styles.HomeNavbar_child_Container_svg_for_all}
            >
              <defs>
          ...
          <div onClick={() => setShow(!show)}>
            <button
              className={styles.HomeNavbar_child_Container_button_for_all}
            >
              Product
            </button>
            {show && <NavbarProduct />}
        ...
        <div className={styles.HomeNavbar_child_Container_div2_for_all}>
          <div>
            <button
            ...
            {/* here logged in user is displayed */}
            {userDisplay && (
          ...
          >
            <button
              className={
                styles.HomeNavbar_child_Container_Try_for_free_button_for_all
              }
            >
              Try for free
            </button>
